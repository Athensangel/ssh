...
public class PoiExcelExportUtil {  
    ...
    public PoiExcelExportUtil(String fileDir,String sheetName){  
         this.fileDir = fileDir;  
         this.sheetName = sheetName;  
         workbook = new HSSFWorkbook();  
    }  
      
    public PoiExcelExportUtil(HttpServletResponse response,String fileName,String sheetName){  
   ...
   /* public static void main(String[] args) {  
        ...
        User user = new User();
        user.setId("123");
        user.setUserName("dcvdr");
        user.setPassWord("bbbbb");
        
        User user2 = new User();
        user2.setId("1232");
        user2.setUserName("dcvdr2");
        user2.setPassWord("bbbbb2");
        
        User user3 = new User();
        user3.setId("1233");
        user3.setUserName("dcvdr3");
        user3.setPassWord("bbbbb3");
        
        
        dataList.add(user);dataList.add(user2);dataList.add(user3);
        //调用  
