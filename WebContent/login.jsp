...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="${pageContext.request.contextPath}/user_userLogin.action" method="post">
            <div class="panel loginbox">
                ...
                <div style="padding:30px;"><input type="submit" class="button button-block bg-main text-big input-big" id="btnLogin" value="登录"></div>
            </div>
            </form>          
        </div>
    </div>
